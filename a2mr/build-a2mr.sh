...
# Scipt Name:	build-a2mr.sh
# Script Ver:	1.0.0
# Description:	Attmpts to builad a deb package from latest libretro a2mr
#		github release
#
...
# upstream vars
DL_URL="https://www.mediafire.com/?v5aoyt9d6ga4hee"
...
main()
{
	...
	# clone
	wget -P "${FILES_DIR} "${DL_URL}" -q -nc --show-progress
