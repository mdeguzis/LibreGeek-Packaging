...
install_prereqs()
{
	...
	libglu1-mesa-dev:i386 llibwxgtk3.0-devi386 libjpeg62-dev:i386 libsdl1.2-dev:i386 libsoundtouch-dev:i386 \
	libsparsehash-dev libwxbase3.0-dev:i386 libwxgtk2.8-dev:i386 libx11-dev:i386 nvidia-cg-dev:i386 \
