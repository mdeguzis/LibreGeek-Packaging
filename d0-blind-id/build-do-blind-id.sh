...
# Scipt Name:	build-libd0-blind-id.sh
# Script Ver:	1.0.8
# Description:	Attmpts to builad a deb package from latest libd0-blind-id
#
# See:		https://github.com/libd0-blind-id/libd0-blind-id
#
# Usage:	./build-libd0-blind-id.sh
# Opts:		[--testing]
...
# upstream vars
SRC_URL="https://github.com/divVerent/d0_blind_id"
TARGET="master"
...
install_prereqs()
{
	...
	sudo apt-get -y --force-yes install build-essential pkg-config bc dh-autoreconf \
	libssl-dev libtommath-dev libgmp-dev
