...
# Scipt name:	build-eduke32.sh
# Script Ver:	0.1.1
# Description:	Attmpts to build a deb package from the latest eduke32 source
#		code.
#
# See:		http://svn.eduke32.com/eduke32/polymer/
#
# Usage:	./build-eduke32.sh
# Opts:		[--testing]
...
# upstream vars
SVN_URL="http://svn.eduke32.com/eduke32/polymer/"
...
install_prereqs()
{
	...
	nasm libgl1-mesa-dev libglu1-mesa-dev libsdl1.2-dev \
	libsdl-mixer1.2-dev libsdl2-dev libsdl2-mixer-dev \
	flac libflac-dev libvorbis-dev libpng-dev \
	libvpx-dev libgtk2.0-dev freepats
...
main()
{
	...
	# Add extras
	cp "${SCRIPTDIR}/eduke32.png" "${SVN_DIR}"
