...
# Scipt name:	build-lgogd-uri.sh
# Script Ver:	0.1.1
# Description:	Attmpts to build a deb package from the laest "lgogd-uri"
#		release
#
# See:		https://github.com/lgogd-uri-emu/lgogd-uri-emu
#
# Usage:	./build-lgogd-uri.sh
# Opts:		[--testing]
...
SRC_URL="https://github.com/ssokolow/lgogd_uri"
TARGET="master"
