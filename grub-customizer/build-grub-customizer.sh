...
# Script Ver:	1.0.0
# Description:	Attempts to build a deb package from latest grub customizer
...
# upstream vars
git_url="https://github.com/ProfessorKaos64/grub-customizer/"
rel_target="master"
...
install_prereqs()
{
	...
	libgtkmm-3.0-dev libssl-dev cmake gettext dpatch libarchive-dev
