...
# Script Ver:	1.0.5
# Description:	Attmpts to build a deb package from Kodi vorbis encoder git source
#
# See:		https://github.com/notspiff/audioencoder.vorbis
# Usage:	build-audioencoder-vorbis.sh
# Opts:		[--testing]
...
# upstream vars
SRC_URL="https://github.com/mdeguzis/audioencoder.vorbis"
TARGET="master"
...
main()
{
	...
	PKGVER=$(cat "${SRC_DIR}/audioencoder.vorbis/addon.xml.in" | grep "version" | sed -sn 2p | sed 's/version=//g;s/  //g;s/"//g')
	#################################################
	# Build platform
	#################################################
