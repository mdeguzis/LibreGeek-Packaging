...
# Scipt Name:	build-crossguid.sh
# Script Ver:	0.1.1
# Description:	Attempts to build a deb package crossguid git source
#
# See:		https://github.com/graeme-hill/crossguid
# Usage:	build-crossguid.sh
# Opts:		[--testing]
...
# upstream vars
git_url="https://github.com/graeme-hill/crossguid"
git_branch="master"
