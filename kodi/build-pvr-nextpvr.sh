...
# Scipt Name:	build-pvr-nextpvr.sh
# Script Ver:	1.0.0
# Description:	Attempts to build a deb package from Kodi PVR nextpvr addon git source
#
# See:		https://github.com/kodi-pvr/pvr.nextpvr
#		http://www.cyberciti.biz/faq/linux-unix-formatting-dates-for-display/
# Usage:	build-pvr-nextpvr.sh
# Opts:		[--testing]
...
# upstream vars
git_url="https://github.com/kodi-pvr/pvr.nextpvr"
git_branch="Jarvis"
