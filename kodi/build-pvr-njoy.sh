...
# Scipt Name:	build-pvr-njoy.sh
# Script Ver:	1.0.0
# Description:	Attempts to build a deb package from Kodi PVR njoy addon git source
#
# See:		https://github.com/kodi-pvr/pvr.njoy
#		http://www.cyberciti.biz/faq/linux-unix-formatting-dates-for-display/
# Usage:	build-pvr-njoy.sh
# Opts:		[--testing]
