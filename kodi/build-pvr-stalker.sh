...
# Scipt Name:	build-pvr-stalker.sh
# Script Ver:	0.1.1
# Description:	Attempts to build a deb package from Kodi PVR stalker addon git source
#
# See:		https://github.com/kodi-pvr/pvr.stalker
#		http://www.cyberciti.biz/faq/linux-unix-formatting-dates-for-display/
# Usage:	build-pvr-stalker.sh
# Opts:		[--testing]
...
# upstream vars
git_url="https://github.com/kodi-pvr/pvr.stalker"
git_branch="Jarvis"
