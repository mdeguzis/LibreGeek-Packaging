...
# Scipt Name:	build-pvr-wmc.sh
# Script Ver:	0.1.1
# Description:	Attempts to build a deb package from Kodi PVR WMC addon git source
#
# See:		https://github.com/kodi-pvr/pvr.wmc
#		http://www.cyberciti.biz/faq/linux-unix-formatting-dates-for-display/
# Usage:	build-pvr-wmc.sh
# Opts:		[--testing]
