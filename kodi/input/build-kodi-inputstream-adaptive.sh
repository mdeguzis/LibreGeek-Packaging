...
# Scipt Name:	build-kodi-inputstream-adaptive.sh
# Script Ver:	1.0.1
# Description:	Attmpts to build a deb package kodi-inputstream-adaptive git source
#
# See:		https://github.com/peak3d/inputstream.adaptive
# Usage:	./build-kodi-inputstream-adaptive.sh
# Opts:		[--testing]
...
install_prereqs()
{
	...
	libkodiplatform-dev, kodi-addon-dev, kodi-input-stream-dev, libexpat1-dev
