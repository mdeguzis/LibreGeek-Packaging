...
# Scipt Name:	build-pvr-filmon.sh
# Script Ver:	0.1.1
# Description:	Attmpts to build a deb package from Kodi PVR filmon addon git source
#
# See:		https://github.com/kodi-pvr/pvr.filmon
#		http://www.cyberciti.biz/faq/linux-unix-formatting-dates-for-display/
# Usage:	build-pvr-filmon.sh
# Opts:		[--testing]
...
# upstream vars
#SRC_URL="https://github.com/kodi-pvr/pvr.filmon"
#TARGET="1.4.7-Krypton"
SRC_URL="https://github.com/mdeguzis/pvr.filmon"
TARGET="Krypton"
...
main()
{
    ...
    PKGVER=$(cat "${SRC_DIR}/pvr.filmon/addon.xml.in" | grep "version" | sed -sn 2p | sed 's/version=//g;s/  //g;s/"//g')
