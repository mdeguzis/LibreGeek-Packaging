...
# Scipt Name:	build-pvr-iptvsimple.sh
# Script Ver:	1.0.0
...
# upstream vars
#SRC_URL="https://github.com/kodi-pvr/pvr.iptvsimple"
#TARGET="2.4.8-Krypton"
SRC_URL="https://github.com/mdeguzis/pvr.iptvsimple"
TARGET="Krypton"
...
install_prereqs()
{
	...
	debhelper cmake kodi-pvr-dev libkodiplatform-dev kodi-addon-dev zlib1g-dev
...
main()
{
    ...
    PKGVER=$(cat "${SRC_DIR}/pvr.iptvsimple/addon.xml.in" | grep "version" | sed -sn 2p | sed 's/version=//g;s/  //g;s/"//g')
