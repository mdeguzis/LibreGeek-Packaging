...
# Scipt Name:	build-pvr-mediaportal-tvserver.sh
# Script Ver:	1.0.0
# Description:	Attmpts to build a deb package from Kodi PVR HTS addon git source
#
# See:		https://github.com/kodi-pvr/pvr.mediaportal.tvserver
#		http://www.cyberciti.biz/faq/linux-unix-formatting-dates-for-display/
# Usage:	build-pvr-mediaportal-tvserver.sh
# Opts:		[--testing]
...
# upstream vars
#SRC_URL="https://github.com/kodi-pvr/pvr.mediaportal.tvserver"
#TARGET="2.4.16-Krypton"
SRC_URL="https://github.com/mdeguzis/pvr.mediaportal.tvserver"
TARGET="Krypton"
...
PKGNAME="kodi-pvr-mediaportal-tvserver"
PKGREV="1"
...
main()
{
    ...
    PKGVER=$(cat "${SRC_DIR}/pvr.mediaportal.tvserver/addon.xml.in" | grep "version" | sed -sn 2p | sed 's/version=//g;s/  //g;s/"//g')
