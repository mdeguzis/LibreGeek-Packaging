...
# Scipt Name:	build-pvr-vuplus.sh
# Script Ver:	0.1.1
# Description:	Attmpts to build a deb package from Kodi PVR HTS addon git source
#
# See:		https://github.com/kodi-pvr/pvr.vuplus/tree/Isengard
#		http://www.cyberciti.biz/faq/linux-unix-formatting-dates-for-display/
# Usage:	build-pvr-vuplus.sh
# Opts:		[--testing]
...
# upstream vars
#SRC_URL="https://github.com/kodi-pvr/pvr.vuplus"
#TARGET="2.4.6-Krypton"
SRC_URL="https://github.com/mdeguzis/pvr.vuplus"
TARGET="Krypton"
...
main()
{
    ...
    PKGVER=$(cat "${SRC_DIR}/pvr.vuplus/addon.xml.in" | grep "version" | sed -sn 2p | sed 's/version=//g;s/  //g;s/"//g')
