...
# Scipt Name:	build-mehstation.sh
# Script Ver:	1.0.0
# Description:	Attmpts to builad a deb package from latest mehstation
#		github release
#
# See:		https://github.com/Aloshi/EmulationStation
#
# Usage:	build-mehstation.sh
#
# Opts:		[--testing]
...
SRC_URL="https://github.com/remeh/mehstation"
TARGET="master"
