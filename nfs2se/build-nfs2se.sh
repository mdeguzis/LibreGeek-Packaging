...
# Script Ver:	0.1.1
# Description:	Attempts to build a deb package from the laest "nfs2se"
#		release
#
# See:		https://github.com/svkaiser/nfs2se
#
# Usage:	./build-nfs2se.sh
# Opts:		[--testing]
...
install_prereqs()
{
	...
	sudo apt-get install -y debhelper gcc libsdl2-dev
