...
# Scipt name:	build-openjazz.sh
# Script Ver:	0.1.1
# Description:	Attmpts to build a deb package from the latest openjazz source
#		code.
#
# See:		https://github.com/AlisterT/openjazz
#
# Usage:	./build-openjazz.sh
# Opts:		[--testing]
...
# upstream vars
SRC_URL="https://github.com/AlisterT/openjazz"
TARGET="master"
...
main()
{
	...
	cp -r "${SCRIPTDIR}/openjazz.png" "${SRC_DIR}"
