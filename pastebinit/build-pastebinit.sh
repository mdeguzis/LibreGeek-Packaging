...
# upstream vars
git_url="https://github.com/ProfessorKaos64/pastebinit"
rel_target="master"
...
install_prereqs()
{
	...
	python-support xsltproc docbook-xml docbook-xsl
...
main()
{
	...
	$pkgname ($pkgver-$upstream_rev+$pkgsuffix$pkgrev) $DIST; urgency=low

	  * Packaged deb for SteamOS-Tools
	  * See: packages.libregeek.org
	  * Works around issue with default PB API being closed to anon pastes
	  * See: https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=778336
