...
# Scipt name:	build-python-patch.sh
# Script Ver:	0.1.1
# Description:	Attmpts to build a deb package from the laest "python-patch"
#		release
#
# See:		https://github.com/python-patch-emu/python-patch-emu
#
# Usage:	./build-python-patch.sh
# Opts:		[--testing]
...
SRC_URL="https://github.com/techtonik/python-patch"
TARGET="1.16"
