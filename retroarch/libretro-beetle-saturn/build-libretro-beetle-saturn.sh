...
# Scipt Name:	build-libretro-beetle-saturn.sh
# Script Ver:	1.0.0
# Description:	Attmpts to builad a deb package from latest libretro beetle-saturn
#		github release
#
# See:		https://github.com/libretro/beetle-saturn-libretro
#
# Usage:	build-libretro-beetle-saturn.sh
# Opts:		[--testing]
...
# upstream vars
SRC_URL="https://github.com/libretro/beetle-saturn-libretro"
TARGET="master"
