...
# Scipt Name:	build-libretro-cap32.sh
# Script Ver:	1.0.0
# Description:	Attmpts to builad a deb package from latest libretro cap32
#		github release
#
# Usage:	build-libretro-cap32.sh
# Opts:		[--testing]
...
# upstream vars
SRC_URL="https://github.com/libretro/libretro-cap32"
TARGET="master"
