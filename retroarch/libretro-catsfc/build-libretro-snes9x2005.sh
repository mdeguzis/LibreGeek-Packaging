...
# Scipt Name:	build-libretro-catsfc.sh
# Script Ver:	1.0.0
# Description:	Attmpts to builad a deb package from latest libretro catsfc
#		github release
#
# See:		https://github.com/libretro/CATSFC-libretro
#
# Usage:	build-libretro-catsfc.sh
# Opts:		[--testing]
...
# upstream vars
SRC_URL="https://github.com/libretro/snes9x2005"
TARGET="master"
...
main()
{
	...
	if [[ -f "debian/changelog" ]]; then
		...
		dch -p --force-distribution -v "${EPOCH}:${PKGVER}+${PKGSUFFIX}" --package \
