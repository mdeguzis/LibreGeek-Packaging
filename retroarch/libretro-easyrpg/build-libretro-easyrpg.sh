...
# Scipt Name:	build-libretro-easyrpg.sh
# Script Ver:	1.0.0
# Description:	Attmpts to builad a deb package from latest libretro easyrpg
#		github release
#
# Usage:	build-libretro-easyrpg.sh
# Opts:		[--testing]
...
# upstream vars
SRC_URL="https://github.com/libretro/easyrpg"
TARGET="master"
