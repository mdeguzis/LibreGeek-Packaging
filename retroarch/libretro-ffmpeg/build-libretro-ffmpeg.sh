...
# Scipt Name:	build-libretro-ffmpeg.sh
# Script Ver:	1.0.0
# Description:	Attmpts to builad a deb package from latest libretro ffmpeg
#		github release
#
# See:		https://github.com/libretro/ffmpeg
#
# Usage:	build-libretro-ffmpeg.sh
# Opts:		[--testing]
...
# upstream vars
SRC_URL="https://github.com/libretro/FFmpeg"
TARGET="master"
...
PKGNAME="libretro-ffmpeg"
epoch="1"
#PKGVER=$(echo ${TARGET} | sed 's/n//g')
PKGVER="1.1.10"
PKGREV="1"
