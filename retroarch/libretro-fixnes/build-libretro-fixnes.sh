...
# Scipt Name:	build-libretro-fixnes.sh
# Script Ver:	1.0.0
# Description:	Attmpts to builad a deb package from latest libretro fixnes
#		github release
#
# Usage:	build-libretro-fixnes.sh
# Opts:		[--testing]
...
# upstream vars
SRC_URL="https://github.com/libretro/fixNES"
TARGET="master"
