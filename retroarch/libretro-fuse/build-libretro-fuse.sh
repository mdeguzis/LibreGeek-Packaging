...
# Scipt Name:	build-libretro-fuse.sh
# Script Ver:	1.0.0
# Description:	Attmpts to builad a deb package from latest libretro fuse
#		github release
#
# See:		https://github.com/libretro/fuse
#
# Usage:	build-libretro-fuse.sh
# Opts:		[--testing]
...
# upstream vars
SRC_URL="https://github.com/libretro/fuse-libretro"
TARGET="master"
