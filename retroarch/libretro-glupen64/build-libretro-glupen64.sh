...
# Scipt Name:	build-libretro-glupen64.sh
# Script Ver:	1.0.0
# Description:	Attmpts to builad a deb package from latest libretro glupen64
#		github release
#
# See:		https://github.com/libretro/glupen64
#
# Usage:	build-libretro-glupen64.sh
# Opts:		[--testing]
...
# upstream vars
SRC_URL="https://github.com/GLupeN64/GLupeN64"
TARGET="master"
