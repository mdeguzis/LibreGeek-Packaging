...
# Scipt Name:	build-libretro-gme.sh
# Script Ver:	1.0.0
# Description:	Attmpts to builad a deb package from latest libretro gme
#		github release
#
# See:		https://github.com/libretro/gme
#
# Usage:	build-libretro-gme.sh
# Opts:		[--testing]
...
# upstream vars
SRC_URL="https://github.com/libretro/libretro-gme"
TARGET="master"
