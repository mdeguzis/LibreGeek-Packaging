...
# Scipt Name:	build-libretro-mame2016.sh
# Script Ver:	1.0.0
# Description:	Attmpts to builad a deb package from latest libretro mame2016
#		github release
#
# See:		https://github.com/libretro/mame2016
#
# Usage:	build-libretro-mame2016.sh
# Opts:		[--testing]
...
# upstream vars
SRC_URL="https://github.com/libretro/mame2016-libretro"
TARGET="master"
...
TARGET_ARCH="amd64"
BUILDER="pdebuild"
# workaround for upstream using $ARCH var
