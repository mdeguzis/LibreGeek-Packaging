...
# Scipt Name:	build-libretro-meowpc98.sh
# Script Ver:	1.0.0
# Description:	Attmpts to builad a deb package from latest libretro meowpc98
#		github release
#
# Usage:	build-libretro-meowpc98.sh
# Opts:		[--testing]
...
# upstream vars
SRC_URL="https://github.com/libretro/libretro-meowPC98"
TARGET="master"
