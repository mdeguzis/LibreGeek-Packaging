...
# upstream vars
git_url="https://github.com/libretro/mgba"
branch="master"
...
main()
{
	...
	if [[ "$transfer_choice" == "y" ]]; then
		...
		if [[ -d "${build_dir}" ]]; then
			...
			# Only move the old changelog if transfer occurs to keep
			# final changelog out of the picture until a confirmed build is made
