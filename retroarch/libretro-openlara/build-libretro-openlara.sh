...
# Scipt Name:	build-libretro-openlara.sh
# Script Ver:	1.0.0
# Description:	Attmpts to builad a deb package from latest libretro openlara
#		github release
#
# Usage:	build-libretro-openlara.sh
# Opts:		[--testing]
...
# upstream vars
SRC_URL="https://github.com/libretro/OpenLara"
TARGET="master"
