...
# Scipt Name:	build-libretro-pocketcdg.sh
# Script Ver:	1.0.0
# Description:	Attmpts to builad a deb package from latest libretro pocketcdg
#		github release
#
# See:		https://github.com/libretro/pocketcdg-libretro
#
# Usage:	build-libretro-pocketcdg.sh
# Opts:		[--testing]
...
# upstream vars
SRC_URL="https://github.com/libretro/libretro-pocketcdg"
TARGET="master"
