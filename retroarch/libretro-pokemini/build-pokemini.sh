...
# Scipt Name:	build-libretro-pokemini.sh
# Script Ver:	1.0.0
# Description:	Attmpts to builad a deb package from latest libretro pokemini
#		github release
#
# See:		https://github.com/libretro/libretro-pokemini
#
# Usage:	build-libretro-pokemini.sh
# Opts:		[--testing]
...
# upstream vars
SRC_URL="https://github.com/libretro/PokeMini"
TARGET="master"
