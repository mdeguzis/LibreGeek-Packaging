...
# Scipt Name:	build-libretro-sameboy.sh
# Script Ver:	1.0.0
# Description:	Attmpts to builad a deb package from latest libretro sameboy
#		github release
#
# See:		https://github.com/libretro/sameboy-libretro
#
# Usage:	build-libretro-sameboy.sh
# Opts:		[--testing]
...
# upstream vars
SRC_URL="https://github.com/libretro/SameBoy"
TARGET="master"
