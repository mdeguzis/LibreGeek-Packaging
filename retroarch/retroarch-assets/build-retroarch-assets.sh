...
#
# See:		https://github.com/libretro/retroarch-assets
#
# Usage:	build-retroarch-assets.sh
# Opts:		[--testing]
...
# upstream vars
SRC_URL="https://github.com/libretro/retroarch-assets/"
TARGET="master"
...
install_prereqs()
{
	...
	checkinstall bc build-essential devscripts debhelper rsync
}
