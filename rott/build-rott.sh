...
# Scipt Name:	  build-rott.sh
# Script Ver:	  0.1.1
# Description:	  Attempts to build a deb package from rott git source
# See:		  https://github.com/h4tr3d/rott
# Usage:	  ./build-rott.sh
# Opts:		  [--testing]
...
# upstream URL
git_url="https://github.com/ProfessorKaos64/rott"
branch="master"
...
install_prereqs()
{
	...
	sudo apt-get install -y --force-yes git devscripts build-essential libsdl1.2-dev \
 	libsdl-mixer1.2-dev
