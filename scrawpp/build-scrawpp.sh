...
# Scipt Name:	build-scrawpp.sh
# Script Ver:	1.0.0
# Description:	Builds simple pacakge for using scrawpp
#
# Usage:	build-scrawpp.sh
# Opts:		[--testing]
...
# upstream vars
SRC_URL="https://gitlab.com/dennis-hamester/scrawpp.git"
TARGET="master"
