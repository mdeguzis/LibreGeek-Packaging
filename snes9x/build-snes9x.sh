...
# Script Ver:	1.0.0
# Description:	Attmpts to builad a deb package from latest snes9x
#		github release
#
# See:		https://github.com/snes9xgit/snes9x
#
...
# upstream vars
SRC_URL="https://github.com/snes9xgit/snes9x"
TARGET="1.54.1"
