...
#		github release
#
# See:		http://archive.ubuntugames.org/dists/ubuntugames/	# inform user of packages
	cat<<- EOF
	#################################################################
...
sourcecode="http://archive.ubuntugames.org/dists/ubuntugames/	# inform user of packages
	cat<<- EOF
	#################################################################
	If package was built without errors you will see it below.
	If you don't, please check build dependency errors listed above.
