...
# BUILD_DIRECTORYs
export BUILD_DIRECTORY="${HOME}/pkg-build-dir"
...
EOF
      ...
      if [ $? -eq 0 ]; then
        ...
        while true; do
            ...
            case $yn in
                [Yy]* ) dput ppa:mdeguzis/steamos-tools ${BUILD_DIRECTORY}/${PKGNAME}-${PKGVER}-${PKGREV}~${pkgrel}_source.changes; break;;
                [Nn]* ) break;;
