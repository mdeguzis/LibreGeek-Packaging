...
# Scipt name:	build-turokex.sh
# Script Ver:	0.1.1
# Description:	Attempts to build a deb package from the laest "turokex"
#		release
#
# See:		https://github.com/svkaiser/TurokEX
#
# Usage:	./build-turokex.sh
# Opts:		[--testing]
