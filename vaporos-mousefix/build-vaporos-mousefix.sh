...
# Scipt name:	build-vaporos-mousefix.sh
# Script Ver:	0.1.1
# Description:	Attmpts to build a deb package from the latest vaporos-mousefix source
#
# See:		https://github.com/sharkwouter/vaporos-brewmaster/tree/master/vaporos-packages/	# inform user of packages
	cat<<- EOF
	#################################################################
...
#
# Usage:	./build-vaporos-mousefix.sh
# Opts:		[--testing]
