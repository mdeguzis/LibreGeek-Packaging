...
# Scipt Name:	build-vulkan.sh
# Script Ver:	1.0.0
# Description:	Attmpts to build a deb package from latest vulkan
#		github release
#
# See:		https://github.com/KhronosGroup/Vulkan-LoaderAndValidationLayers
#
# Usage:	build-vulkan.sh
# Opts:		[--testing]
...
# upstream vars
GIT_URL="https://github.com/KhronosGroup/Vulkan-LoaderAndValidationLayers"
TARGET="sdk-1.0.21.0"
