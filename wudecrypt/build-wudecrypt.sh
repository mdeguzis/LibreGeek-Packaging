...
# Scipt Name:	build-wudecrypt.sh
# Script Ver:	1.0.0
# Description:	Builds simple pacakge for wudecrypt
#		https://github.com/maki-chan/wudecrypt
#
#
# Usage:	./build-wudecrypt.sh [option]
...
# upstream vars
SRC_URL="https://github.com/maki-chan/wudecrypt"
TARGET="master"
...
PKGNAME="wudecrypt"
# Set base version on latest release tag
PKGVER="0.1.1"
PKGREV="1"
PKGSUFFIX="${DATE_SHORT}bsos"
DIST="brewmaster"
URGENCY="low"
