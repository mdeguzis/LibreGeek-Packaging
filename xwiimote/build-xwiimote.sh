...
# Scipt Name:	build-xwiimote.sh
# Script Ver:	0.1.1
# Description:	Attempts to build a deb package from xwiimote git source
#
# See:		https://github.com/dvdhrm/xwiimote
#	
...
install_prereqs()
{
	...
	debhelper libudev-dev libncurses5
...
main()
{
	...
	if [[ "$transfer_choice" == "y" ]]; then
		...
		# transfer files
		if [[ -d "${build_dir}" ]]; then
			rsync -arv --exclude-from=$HOME/.config/SteamOS-Tools/repo-exclude.txt ${build_dir}/${pkgname}_${pkgver}* mikeyd@archboxmtd:/home/mikeyd/packaging/SteamOS-Tools/incoming
		fi
